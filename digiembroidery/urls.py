...
urlpatterns = [
    ...
    path('logout', LogoutView.as_view(template_name='embroidery/logout.html'),name='logout'),
    ...
    path('update-quote/<int:id>/', views.update_quote, name='update-quote'),  # Example pattern

    path('delete-quote/<int:id>/', views.delete_quote, name='delete-quote'),  # Ensure this line exists
